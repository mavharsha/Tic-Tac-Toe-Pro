...
public class GameActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("opponent", "The Opponent is "+ player_type);
        ...
        if(player_type.equalsIgnoreCase("computer"))
        {
            ...
            Log.v("Selected opponent", "Its human vs " + player_two.getName());
        }
        else
        {
    ...
    private void afterMove() {
        ...
        if(Board.occupied == 9 & !Board.ended){
    ...
    public void changeCurrentPlayer(){
        ...
        Log.d("GameActivity", "Changed the player, current player is " + currentPlayer.getName());
    }
    ...
    public void initialize(){
        ...
        imageButton[0][0].setClickable(true);
        imageButton[0][1].setClickable(true);
        imageButton[0][2].setClickable(true);

        imageButton[1][0].setClickable(true);
        imageButton[1][1].setClickable(true);
        imageButton[1][2].setClickable(true);

        imageButton[2][0].setClickable(true);
        imageButton[2][1].setClickable(true);
        imageButton[2][2].setClickable(true);

        imageButton[0][0].setImageResource(0);
        imageButton[0][1].setImageResource(0);
        imageButton[0][2].setImageResource(0);

        imageButton[1][0].setImageResource(0);
        imageButton[1][1].setImageResource(0);
        imageButton[1][2].setImageResource(0);

        imageButton[2][0].setImageResource(0);
        imageButton[2][1].setImageResource(0);
        imageButton[2][2].setImageResource(0);
